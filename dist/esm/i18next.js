...
import LanguageUtil from './LanguageUtils.js';
...
var I18next = function (_EventEmitter) {
  ...
  _createClass(I18next, [{
    ...
    value: function () {
      var _runDetectLanguageHooks = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3() {
    ...
    value: function () {
      var _runCacheLanguageHooks = _asyncToGenerator(_regeneratorRuntime.mark(function _callee4(lng) {
    ...
    key: "init",
    value: function () {
      var _init = _asyncToGenerator(_regeneratorRuntime.mark(function _callee5() {
        var _this4 = this;
    ...
    key: "load",
    value: function () {
      var _load = _asyncToGenerator(_regeneratorRuntime.mark(function _callee6(toLoad) {
        var _this5 = this;
    ...
    key: "loadNamespace",
    value: function () {
      var _loadNamespace = _asyncToGenerator(_regeneratorRuntime.mark(function _callee7(ns, lng) {
    ...
    key: "changeLanguage",
    value: function () {
      var _changeLanguage = _asyncToGenerator(_regeneratorRuntime.mark(function _callee8(lng) {
